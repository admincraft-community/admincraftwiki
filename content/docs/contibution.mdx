...
<Steps>
1. Fork the repository from [admincraft-community/admincraftwiki](https://github.com/admincraft-community/admincraftwiki)
2. Clone your fork: `git clone https://github.com/YOUR-USERNAME/admincraftwiki.git`
