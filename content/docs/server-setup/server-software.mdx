...
<Callout type="info" title="Note">
These softwares are sometimes referred to as "Backend" servers, in reference to [Proxy Servers](#proxy-servers), which serve a different purpose in managing network traffic.
</Callout>
...
<Card href="https://files.minecraftforge.net/net/minecraftforge/forge/" title="Download">
  Download a copy of Forge via [minecraftforge.net](https://files.minecraftforge.net/).
</Card>
...
<Card href="https://papermc.io/downloads/paper" title="Download">
  Download a copy of the latest PaperMC server software via
  [papermc.io](https://papermc.io).
</Card>

### Pufferfish

Pufferfish is a fork of [Paper](#paper-recommended) that adds significant optimizations to the game without much impact to normal gameplay.
...
<Card
  href="https://purpurmc.org/download/purpur"
  title="Download">
  Download a copy of the latest Purpur server software via
  [purpurmc.org](https://purpurmc.org/).
</Card>
...
<Callout type="warn" title="Warning: Folia is not completely usable!">
  ...
  Before committing to Folia, consider testing more stable alternatives like [Paper](#paper-recommended) or [Pufferfish](#pufferfish), which offer more mature solutions for server stability and performance.
  ...
  **Folia does not inherently fix lag** and has specific requirements for its playerbase.
  For Folia to perform optimally, players need to be spread out across the world.
  If players are clustered together, the number of entities in each region will increase, potentially causing more lag and
  diminishing the benefits compared to its upstream project, [Paper](#paper-recommended).
</Callout>
...
<Callout type="warn" title="Warning: MultiPaper is highly unstable!">
  MultiPaper is notoriously unstable and is not recommended for production use. While it may be suitable for experimental or personal projects, you should carefully consider whether you truly need to use it. \
    ...
    Using [Velocity](#velocity-recommended) and [Paper](#paper-recommended) (or a Paper fork such as [Pufferfish](#pufferfish) or [Purpur](#purpur)) often provides a more reliable and scalable approach for improving server performance. Together, they allow for better load balancing, reduced lag, and an overall smoother experience for both players and server admins. \
...
<Card href="https://papermc.io/downloads/velocity" title="Download">
  Download a copy of the latest Velocity proxy software via [papermc.io](https://papermc.io/).
</Card>
...
<Card href="https://papermc.io/downloads/waterfall" title="Download">
  Download a copy of the latest Waterfall proxy software via [papermc.io](https://papermc.io/).
</Card>
...
<Cards>
    <Card href="https://cuberite.org/" title = "Cuberite">
